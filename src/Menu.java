...
public class Menu {
    ...
    public List<Portata> getPortataByCategory(Class category) {
        ...
        if (category.equals(Bevanda.class)) {
            ...
            for (Portata portata : getPortate()) {if (portata instanceof Secondo) {categoryList.add(portata);}}
        } else if (category.equals(Dessert.class)) {
            for (Portata portata : getPortate()) {if (portata instanceof Dessert) {categoryList.add(portata);}}
        }
        return categoryList;
    }
